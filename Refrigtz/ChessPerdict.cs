                            ...
                            if (System.Math.Abs(this.TableList[index][Row, Column]) == 1)
                            {
                                ...
                                if (a == Color.Gray)
                                {
                                    try
                                    {
                                        ...
                                        SolderesOnTable[So1] = new DrawSoldier(MovementsAStarGreedyHuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHuristicT, OnlySelfT, AStarGreedyHuristicT, ArrangmentsChanged, Row, Column, a, this.TableList[index], 1, false, So1, ref THIS);
                                        //Increase So1.
                                        So1++;
                                        if (So1 > SodierMidle)
                                        {
                                ...
                                else
                                {
                                    try
                                    {
                                        ...
                                        SolderesOnTable[So2] = new DrawSoldier(MovementsAStarGreedyHuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHuristicT, OnlySelfT, AStarGreedyHuristicT, ArrangmentsChanged, Row, Column, a, this.TableList[index], -1, false, So2, ref THIS);
                                        //Increase So2.
                                        So2++;
                                        if (So2 > SodierHigh)
                                            SodierHigh++;
