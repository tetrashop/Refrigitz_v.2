...
void init_params(){
	Lever[RANK_2] = make_score(Options["r2_mg"], Options["r2_eg"]);
	Lever[RANK_3] = make_score(Options["r3_mg"], Options["r3_eg"]);
	Lever[RANK_4] = make_score(Options["r4_mg"], Options["r4_eg"]);
	Lever[RANK_5] = make_score(Options["r5_mg"], Options["r5_eg"]);
	Lever[RANK_6] = make_score(Options["r6_mg"], Options["r6_eg"]);
	Lever[RANK_7] = make_score(Options["r7_mg"], Options["r7_eg"]);
}
