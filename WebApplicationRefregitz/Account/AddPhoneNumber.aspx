<%@ Page Title="Phone Number" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddPhoneNumber.aspx.cs" Inherits="WebApplicationRefregitz.Account.AddPhoneNumber" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="Installer-horizontal">
        ...
        <div class="Installer-group">
            ...
            <div class="col-md-10">
                <asp:TextBox runat="server" ID="PhoneNumber" CssClass="Installer-control" TextMode="Phone" />
