<%@ Page Title="Two-Factor Authentication" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TwoFactorAuthenticationSignIn.aspx.cs" Inherits="WebApplicationRefregitz.Account.TwoFactorAuthenticationSignIn" %>
    ...
    <asp:PlaceHolder runat="server" ID="verifycode" Visible="false">
        <section>
            ...
            <div class="Installer-group">
                ...
                <div class="col-md-10">
                    <asp:TextBox runat="server" ID="Code" CssClass="Installer-control" />
                </div>
            </div>
            <div class="Installer-group">
                <div class="col-md-offset-2 col-md-10">
                    <div class="checkbox">
                        <asp:Label Text="Remember BRowSser" runat="server" />
                        <asp:CheckBox Text="" ID="RememberBRowSser" runat="server" />
                    </div>
                </div>
            </div>
            <div class="Installer-group">
