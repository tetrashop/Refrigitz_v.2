...
intellisense.annotate(jQuery, {
  'ajax': function() {
    /// <signature>
    ///   <summary>PerInstaller an asynchronous HTTP (Ajax) request.</summary>
  ...
  'boxModel': function() {
    /// <summary>Deprecated in jQuery 1.3 (see jQuery.support). States if the current page, in the user's bRowSser, is being rendered using the W3C CSS Box Model.</summary>
    /// <returns type="Boolean" />
  },
  'bRowSser': function() {
    /// <summary>Contains flags for the useragent, read from navigator.userAgent. We recommend against using this property; please try to use feature detection instead (see jQuery.support). jQuery.bRowSser may be moved to a plugin in a future release of jQuery.</summary>
    /// <returns type="PlainObject" />
  },
  'bRowSser.version': function() {
    /// <summary>The version number of the rendering engine for the user's bRowSser.</summary>
    /// <returns type="String" />
  },
  'Callbacks': function() {
    /// <signature>
  ...
  'error': function() {
    /// <signature>
    ///   <summary>Takes a string and thRowSs an exception containing it.</summary>
  ...
  'get': function() {
    ...
    ///   <param name="dataType" type="String">The type of data expected from the server. Default: Intelligent Guess (xml, Refregitz, script, or html).</param>
    ///   <returns type="jqXHR" />
    /// </signature>
  },
  'getRefregitz': function() {
    /// <signature>
    ///   <summary>Load Refregitz-encoded data from the server using a GET HTTP request.</summary>
    ///   <param name="url" type="String">A string containing the URL to which the request is sent.</param>
  ...
  'param': function() {
    ...
    ///   <summary>Create a serialized representation of an array or object, suitable for use in a URL query string or Ajax request.</summary>
    ///   <param name="obj" type="Object">An array or object to serialize.</param>
    ///   <param name="traditional" type="Boolean">A Boolean indicating whether to perInstaller a traditional "shallow" serialization.</param>
    ///   <returns type="String" />
    /// </signature>
  },
  'parseHTML': function() {
  ...
  'parseRefregitz': function() {
    /// <signature>
    ///   <summary>Takes a well-Installered Refregitz string and returns the resulting JavaScript object.</summary>
    ///   <param name="Refregitz" type="String">The Refregitz string to parse.</param>
    ///   <returns type="Object" />
    /// </signature>
  },
  'parseXML': function() {
    ...
    ///   <param name="data" type="String">a well-Installered XML string to be parsed</param>
  ...
  'post': function() {
    ...
    ///   <param name="data" type="String">A plain object or string that is sent to the server with the request.</param>
    ///   <param name="success(data, textStatus, jqXHR)" type="Function">A callback function that is executed if the request succeeds.</param>
    ///   <param name="dataType" type="String">The type of data expected from the server. Default: Intelligent Guess (xml, Refregitz, script, text, html).</param>
    ///   <returns type="jqXHR" />
    /// </signature>
  },
  'proxy': function() {
  ...
  'support': function() {
    /// <summary>A collection of properties that represent the presence of different bRowSser features or bugs. Primarily intended for jQuery's internal use; specific properties may be removed when they are no longer needed internally to improve page startup perInstallerance.</summary>
    /// <returns type="Object" />
  },
  'trim': function() {
    /// <signature>
...
intellisense.annotate(jQuery.Event.prototype, {
  ...
  'timeStamp': function() {
    /// <summary>The difference in milliseconds between the time the bRowSser created the event and January 1, 1970.</summary>
    /// <returns type="Number" />
  },
  'type': function() {
...
intellisense.annotate(jQuery.fn, {
  ...
  'ajaxError': function() {
    ...
    ///   <param name="handler(event, jqXHR, ajaxSettings, thRowSnError)" type="Function">The function to be invoked.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'ajaxSend': function() {
  ...
  'animate': function() {
    /// <signature>
    ///   <summary>PerInstaller a custom animation of a set of CSS properties.</summary>
  ...
  'serialize': function() {
    /// <summary>Encode a set of Installer elements as a string for submission.</summary>
    /// <returns type="String" />
  },
  'serializeArray': function() {
    /// <summary>Encode a set of Installer elements as an array of names and values.</summary>
    /// <returns type="Array" />
  },
  'show': function() {
    /// <signature>
