...
(function ($, window, undefined) {
    ...
    signalR._ = {
        ...
        transportError: function (message, transport, source, context) {
            var e = error(message, source, context);
    ...
    signalR.transports.webSockets = {
        ...
        start: function (connection, onSuccess, onFailed) {
            ...
            if (!connection.socket) {
                ...
                url += transportLogic.getUrl(connection, name, reconnecting);
        ...
        reconnect: function (connection) {
            transportLogic.reconnect(connection, name);
        },
...
(function ($, window, undefined) {
    ...
    signalR.transports.foreverFrame = {
        ...
        start: function (connection, onSuccess, onFailed) {
            ...
            // Build the url
            url = transportLogic.getUrl(connection, name);
            url += "&frameId=" + frameId;
...
(function ($, window, undefined) {
    ...
    hubProxy.fn = hubProxy.prototype = {
        ...
        hasSubscriptions: function () {
            return hasMembers(_.callbackMap);
        },
    ...
    hubConnection.fn.createHubProxy = function (hubName) {
        ...
        var proxy = proxies[hubName];
        if (!proxy) {
            proxy = hubProxy(this, hubName);
            proxies[hubName] = proxy;
        }

        _registerSubscribedHubs();
